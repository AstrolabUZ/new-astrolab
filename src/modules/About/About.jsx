    ...
    <section className="pt-[100px] wrapper ">
      <div className="flex flex-col gap-4">
        ...
        <p className="lg:text-xl text-sm">
          ...
          Мы были основаны в 2019 году двумя ИТ-специалистами, которые были увлечены использованием технологий, чтобы изменить мир к лучшему. За короткий срок мы смогли себя зарекомендовать на рынке и получить доверие наших заказчиков. Мы стремимся помочь нашим клиентам в достижении их целей, и мы рады видеть, что ждет нашу компанию в будущем.
        </p>
        <p className="lg:text-xl text-sm">
          Что мы делаем
